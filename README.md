...
- Ротация моделей GPT при ошибке 429 (rate limit): автоматическое переключение между моделями
...
- Автоматическая ротация моделей при ошибке 429 (порядок: Qwen → DeepSeek → ChatGPT → остальные)
